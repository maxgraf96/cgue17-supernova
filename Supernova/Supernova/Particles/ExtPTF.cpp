...
bool ExtPTF::InitalizeParticleSystem()
{
	...
	shVertexUpdate.LoadShader("Shader\\ExtPTF\\particles_update.vert", GL_VERTEX_SHADER);
	shGeomUpdate.LoadShader("Shader\\ExtPTF\\particles_update.geom", GL_GEOMETRY_SHADER);
	...
	shVertexRender.LoadShader("Shader\\ExtPTF\\particles_render.vert", GL_VERTEX_SHADER);
	shGeomRender.LoadShader("Shader\\ExtPTF\\particles_render.geom", GL_GEOMETRY_SHADER);
	shFragRender.LoadShader("Shader\\ExtPTF\\particles_render.frag", GL_FRAGMENT_SHADER);
...
void ExtPTF::UpdateParticles(float fTimePassed)
{
...
void ExtPTF::SetMatrices(glm::mat4* a_matProjection, glm::vec3 vEye, glm::vec3 vView, glm::vec3 vUpVector)
{
...
void ExtPTF::SetGeneratorProperties(glm::vec3 a_vGenPosition, glm::vec3 a_vGenVelocityMin, glm::vec3 a_vGenVelocityMax, glm::vec3 a_vGenGravityVector, glm::vec3 a_vGenColor, float a_fGenLifeMin, float a_fGenLifeMax, float a_fGenSize, float fEvery, int a_iNumToGenerate)
{
